# Část šestá, sedmá a osmá — Regulace cen a úhrad léčivých přípravků, zdravotnických prostředků a potravin pro zvláštní lékařské účely (§§ 39a–39zj)

> **Téma kapitoly:** tři navazující části tvoří **regulační jádro lékové ekonomiky** veřejného zdravotního pojištění. **Část šestá** (§§ 39a–39q) upravuje **cenovou a úhradovou regulaci léčivých přípravků a potravin pro zvláštní lékařské účely** v rámci klasického správního řízení vedeného **Státním ústavem pro kontrolu léčiv** (dále „**Ústav**" — SÚKL). **Část sedmá** (§§ 39r–39z) zavedla od roku 2019 (zák. č. 282/2018 Sb.) **kategorizační režim zdravotnických prostředků na poukaz** — kompenzační pomůcky, ortopedické pomůcky, inkontinenční pomůcky atd. — postavený na **ohlašovacím** (notifikačním) principu místo plnohodnotného správního řízení. **Část osmá** (§§ 39za–39zj) je nejmladší vrstva (zák. č. 371/2021 Sb., účinný od 1. 1. 2022 + reforma k 1. 1. 2024); zavádí **kategorizaci potravin pro zvláštní lékařské účely** (FSMP) podle přílohy č. 6 zákona.
>
> Společnou logikou je trojúhelník **cena výrobce ↔ obchodní přirážka ↔ úhrada ze zdravotního pojištění** s **doplatkem pojištěnce** rovným rozdílu mezi cenou pro konečného spotřebitele a úhradou. Cílem regulace je: (i) **omezit cenu** (maximální cena výrobce = strop), (ii) **zaručit alespoň jeden plně hrazený přípravek** ve skupině terapeuticky zaměnitelných léčiv (§ 39c odst. 5 ve spojení s přílohou č. 2 — tzv. „**jeden plně hrazený**"), (iii) **chránit pojištěnce** stropem doplatků (limit dle § 16b — komentován v dílu 02), (iv) **zajistit dostupnost** terapeutických alternativ pro vzácná onemocnění a vysoce inovativní léčbu.
>
> ⚠ **Pozn. ke struktuře zákona:** tradiční dělení komentářů hovoří o „**hrazené péči**" (§§ 13–18 — díl 02 tohoto komentáře) a „**smluvních vztazích s poskytovateli**" (§§ 17–17a — taktéž díl 02). Části šestá a sedmá v jazyce zákona č. 48/1997 Sb. **nejsou** o obecných smlouvách ZP↔PZS ani o vyhlášce o rámcových smlouvách (§ 17 odst. 5 — úhradová vyhláška), nýbrž **výhradně o správním řízení o cenách a úhradách léčiv, zdravotnických prostředků a FSMP**. Úhradová vyhláška MZd (§ 17 odst. 5), DRG-úhrady lůžkové péče, výběrová řízení MZd na PZS dle § 46 a vrchnostenský regulační aparát systému jsou systematicky řešeny v jiných částech zákona (zejm. § 17 a 46) — komentář se k nim vrací jen okrajově tam, kde se s úhradovou problematikou léčiv prolínají.

## ČÁST ŠESTÁ — Regulace cen a úhrad léčivých přípravků a potravin pro zvláštní lékařské účely

### Úvodní mapa institutů

| Institut | Klíčový § | Funkce |
|---|---|---|
| **Maximální cena výrobce** | § 39a | strop ceny, kterou výrobce/držitel registrace smí účtovat |
| **Výše a podmínky úhrady** | § 39b–39c | kolik hradí ZP a za jakých podmínek (preskripční, indikační, použití na specializovaném pracovišti) |
| **Referenční skupina** | § 39c | skupina v zásadě terapeuticky zaměnitelných léčiv se shodnou základní úhradou |
| **Základní úhrada** | § 39c odst. 2 | jednotná částka úhrady za **obvyklou denní terapeutickou dávku** (ODTD) v rámci referenční skupiny |
| **Vysoce inovativní léčivý přípravek (VILP)** | § 39d | dočasná úhrada 3+2 roky pro průlomovou léčbu — režim „managed entry" |
| **Léčivý přípravek pro vzácné onemocnění (orphan)** | § 39da | poradní orgán MZd, závazné stanovisko MZd, dopad na rozpočet sdílí výrobce |
| **Imunizační přípravky** | § 39db | poradní orgán pro imunizaci, závazné stanovisko MZd |
| **Úhradová soutěž** | § 39e | elektronická aukce SÚKL → nejnižší úhrada → 18 měsíců závazek dodávek |
| **Hloubková revize** | § 39l | periodická revize celé referenční skupiny |
| **Zkrácená revize** | § 39p | rychlejší revize jen výše úhrad |

> ℹ **Stojí mimo část šestou:** „**úhradová vyhláška**" (§ 17 odst. 5 — vydávaná každoročně MZd) určuje úhrady **zdravotních služeb a výkonů** poskytovatelům (DRG, paušál, kapitace) — nikoli léčiv. Léčiva mají vlastní **„Seznam SÚKL"** (§ 39n, vydávaný k 27. dni měsíce) jako právní akt sui generis (opatření obecné povahy v širším smyslu).

## § 39a — Stanovení maximálních cen léčivých přípravků
...
§ 39a je **klíčový mechanismus mezinárodního cenového srovnávání** (tzv. **external reference pricing, ERP**) — strop ceny výrobce v ČR se odvozuje od cen v zahraničí. Smyslem je zabránit, aby ČR platila více než průměr nejlevnějších evropských trhů.

#### Země referenčního koše (odst. 2 písm. a)

| Pojem | Definice |
|---|---|
| **Země referenčního koše** | členské státy EU **s výjimkou** Bulharska, ČR, Estonska, Lucemburska, Rakouska, Rumunska, Řecka, Kypru a Malty |
| **Algoritmus výpočtu** | průměr cen ze **3 zemí** koše s **nejnižší cenou** posuzovaného přípravku, pokud je přítomen alespoň ve **3** zemích koše |
| **Subsidiární postupy** | (b) cena z písemného ujednání se ZP ve veřejném zájmu (min. 1 rok, výpovědní lhůta 3 měsíce); (c) cena nejbližšího terapeuticky porovnatelného přípravku |

Filozofie výběru koše: vyřazeny státy s **netypickým cenovým prostředím** — buď strukturálně levné východoevropské státy (Bulharsko, Rumunsko, Estonsko) nebo malé trhy s atypickými dohodami (Lucembursko, Malta, Kypr), či trhy se silnou parallelní distribucí (Rakousko, Řecko). Cíl: srovnávat se **standardními trhy západní Evropy** a zachytit tam dosažitelný cenový strop.

#### Léčiva „významná pro poskytování zdravotní péče" (odst. 3)

Specifický cenový režim pro přípravky, u nichž MZd ohlásí veřejný zájem na zajištění dostupnosti — typicky strategická léčiva (antibiotika rezerv, antidota, vakcíny). Algoritmus je velkorysejší:

- průměr ze **až 7 zemí** referenčního koše s nejnižší cenou (přítomnost ve 2 stačí), nebo
- průměr cen ze všech ČS EU, nebo
- cena nejbližšího porovnatelného přípravku z ČR.

Rozšíření koše „nahoru" (až 7 zemí) má pragmatický cíl: u strategických léčiv připustit i vyšší cenu, aby výrobce neopustil český trh.

#### „Podobný přípravek" — generikové slevy (odst. 5–7)

Vstoupí-li na trh **podobný přípravek** (= terapeuticky zaměnitelný — generikum nebo biosimilar dle § 39b odst. 4), zavádí se **automatické snížení ceny** prvního podobného v referenční skupině:

| Typ podobného přípravku | Snížení ceny dle § 39a odst. 6 |
|---|---|
| **Biosimilar** (první podobný v referenční skupině, je-li dosud jediný originální biologický přípravek) | **−30 %** |
| **Generikum** (první podobný, je-li dosud jediný hrazený přípravek = originál) | **−40 %** |
| **Jiný podobný přípravek** (nikoliv generikum, např. nový brand v zavedené třídě) | **−15 %** |

Stejné procentuální slevy se zrcadlí v § 39c odst. 9 u **základní úhrady** referenční skupiny (kaskáda: vstup generika sníží jak cenu prvního generika, tak základní úhradu celé skupiny — všechny ostatní hrazené přípravky musí tedy buď snížit cenu, nebo se stát „doplatkovými").

> 📌 **Praktický dopad „40% pravidla":** vstupem prvního generika klesá cenový strop o 40 %, vstupem druhého (a dalších) pak referenční mechanismus § 39c odst. 2 písm. a) tlačí cenu k **nejnižší ceně v EU** (vč. států levných koše). To je nejúčinnější systémový nástroj snižování farmaceutických výdajů — generická konkurence v jediném referenční skupině může vést k poklesu cen o 70–90 % oproti originálu během 3–5 let.

#### Prováděcí vyhláška MZd (odst. 4)

Detaily jsou v **prováděcí vyhlášce MZd č. 376/2011 Sb.** (k § 39a–39u): rozhodné období, přepočet cizí měny, dostupnost přípravku, pravidla pro vyloučení atypických cen, přípustné odchylky velikosti balení atd. Bez vyhlášky je § 39a nepoužitelný — vyhláška je integrální součástí cenového algoritmu.

## § 39b — Zásady stanovení výše a podmínek úhrady
...
§ 39b je **algoritmem výpočtu úhrady** (nikoli ceny). Hradí se zpravidla méně než cena — rozdíl je **doplatek pacienta** (počítaný do limitu dle § 16b).

#### Posuzovací kritéria (odst. 2)

Ústav musí při stanovení **úhrady** komplexně posoudit 12 kritérií (a–l):

| Kritérium | Charakter |
|---|---|
| a) terapeutická účinnost a bezpečnost | klinický základ |
| b) závažnost onemocnění | etický faktor (vyšší tolerance pro závažné nemoci) |
| c) **nákladová efektivita (CEA) + dopad do rozpočtu (BIA)** | farmakoekonomický pilíř (povinné pro nákladné přípravky dle § 15 odst. 9) |
| d) **veřejný zájem** (§ 17 odst. 2) | rezervní klauzule pro mimořádné případy |
| i) nahraditelnost jiným hrazeným přípravkem | komparativní hledisko |
| j) dopad na finanční prostředky ZP | makroekonomický rozměr |
| k) doporučené postupy odborných institucí | medical guidelines |
| l) **zpráva o společném klinickém hodnocení (EU HTA)** | nový pilíř od 2025 — viz nař. (EU) 2021/2282 o HTA |

> 📌 **EU HTA — písm. l):** od **12. 1. 2025** se uplatňuje **nařízení (EU) 2021/2282** o hodnocení zdravotnických technologií. Pro **onkologická léčiva, ATMP** (genové, buněčné terapie) a léčiva pro vzácná onemocnění probíhá tzv. **Joint Clinical Assessment (JCA)** na unijní úrovni; jeho zpráva je závazným podkladem pro národní HTA. Cíl: harmonizovat klinické hodnocení v EU a urychlit vstup inovativní léčby. Česká úprava recipuje JCA jako jedno z kritérií Ústavu a v § 39f odst. 11 řeší ochranu obchodního tajemství v dokumentaci dle čl. 10 odst. 2 nařízení.

#### Pojem „podobný přípravek" (odst. 4–8)

Klíčový pojem celého systému:

- **Podobný přípravek** = shodná léčivá látka (LL) + shodná/obdobná léková forma + terapeutická zaměnitelnost. Pro biologika: podobná biologická látka + obdobná léková forma.
- **Původní hrazený přípravek** = první hrazený přípravek dané LL (typicky originál + případně jeho follow-on od stejného držitele).
- **První podobný přípravek** = první podobný přípravek **odlišného držitele** — typicky první generikum nebo biosimilar.

První podobný přípravek získává úhradu zrcadlově k cenové slevě dle § 39a odst. 6 (biosimilar −30 %, generikum −40 %, jiný −15 %). Tato hodnota se pak stává základní úhradou celé referenční skupiny (§ 39c odst. 9).

#### Stanovení podmínek úhrady (odst. 10) a zvýšená úhrada (odst. 11)

**Podmínky úhrady** se dělí na:

- **Preskripční omezení** — kdo smí předepsat (specialista, ambulantní vs. lůžkový, atestace)
- **Indikační omezení** — pro které diagnózy/stadia/skupiny pacientů je úhrada vázána
- **Použití na specializovaném pracovišti** (§ 15 odst. 11) — typické pro VILP a biologika

Tyto podmínky se v lékové databázi SÚKL označují kódy typu „P", „L/SPC" atd. Lékárník je nesmí přehlížet — recept bez naplnění podmínek úhrady proplácí pacient sám.

**Zvýšená úhrada** (odst. 11): nad rámec základní úhrady lze stanovit **jednu** dodatečnou vyšší úhradu pro vybranou indikaci či skupinu pacientů. Funkce: zachovat plnou úhradu drahého originálu pro vybraný subset pacientů (např. pediatrie, rezistentní formy), zatímco standardní úhrada zůstává nízká dle referenční skupiny.

## § 39c — Referenční skupiny a základní úhrada
...
| Stupeň | Mechanismus | Praktická logika |
|---|---|---|
| **a)** | **nejnižší cena výrobce v EU** za ODTD u dostupného přípravku v ČR | ERP — pull k unijnímu minimu |
| **b)** | denní náklady jiné terapie ve stejné indikaci (cost-minimization) | komparátor terapeuticky srovnatelný |
| **c)** | cena z **písemného ujednání se ZP ve veřejném zájmu** (je-li nižší) | nabídnutá sleva od výrobce |
| **d)** | úhrada z **všepojišťovenské dohody** s držitelem registrace (je-li nejnižší ze všech) | konsenzuální mechanismus |

> 📌 **„Dostupný přípravek" (odst. 2 písm. a):** přípravek je „dostupný" jen tehdy, má-li podíl **≥ 5 %** na celkovém prodeji v zásadě terapeuticky zaměnitelných přípravků s touž LL v rozhodném období. Tím se brání spekulativním importům „za 1 balení" jen kvůli ovlivnění základní úhrady; současně to chrání trh před cenovou dumpingovou manipulací.

#### Nízkoúčinná léčiva (odst. 3)

Pro referenční skupiny **léčiv s nízkou účinností, nepoužívaných k příčinné léčbě, nebo k léčbě nezávažných onemocnění** je základní úhrada **nejvýše 60 %** výpočtu dle odst. 2. Klasické příklady: některá venotonika, hepatoprotektiva, nootropika — pojišťovna hradí jen omezeně, zbytek je doplatek.

#### Pravidlo „jeden plně hrazený" (odst. 5)

> *V případě, že by při stanovení úhrady podle § 39b až 39e nebyl v některé ze skupin léčivých látek uvedených v příloze č. 2 tohoto zákona bez ohledu na terapeutickou zaměnitelnost alespoň 1 léčivý přípravek plně hrazen, Ústav upraví rozhodnutím úhrady tak, aby nejméně nákladný léčivý přípravek ze skupiny posuzovaných léčivých přípravků byl plně hrazen.*

Klíčová **garance pojištěnce**: v každé z farmakoterapeuticky vymezených skupin (příloha č. 2 — antibiotika, hypertonika, antidiabetika atd.) musí být **alespoň jeden přípravek bez doplatku**. Není-li tomu tak po standardním výpočtu, Ústav úhrady automaticky **navýší** nejlevnějšímu přípravku skupiny. To je ústavně významné: zaručuje, že pacient nikdy nezůstane „rukojmím doplatků" v zásadní lékové třídě.

#### Generická a biosimilar kaskáda (odst. 9–10)

Vstoupí-li **první podobný přípravek**, automaticky se sníží i základní úhrada celé RS:

| Typ prvního podobného | Snížení základní úhrady |
|---|---|
| **Generikum** | **−40 %** |
| **Biosimilar** | **−30 %** |
| **Jiný podobný** (např. další originál) | **−15 %** |

Toto snížení se v rámci jedné skupiny **provede pouze jednou** (odst. 10) — i kdyby pak vstoupila další generika, kaskáda se neopakuje. Pro další konkurenční tlak slouží referenční mechanismus dle odst. 2 písm. a) (push k nejnižší ceně EU).

#### Zvlášť účtované léčivé přípravky (ZÚLP) — nepřímý odkaz

Zákon implicitně rozeznává dva režimy úhrady léčiv:

| Režim | Typický představitel | Komu se účtuje |
|---|---|---|
| **Recept (lékárna)** | běžná farmakoterapie | pacient platí doplatek + ZP úhradu lékárně |
| **Zvlášť účtovaný (ZÚLP)** | nemocniční / centrová léčba (onkologie, biologika) | ZP přímo PZS (poskytovateli), který přípravek aplikuje |

ZÚLP jsou součástí **balíčkové úhrady DRG/výkonu** nebo se účtují **samostatně na žádanku** (§ 39h odst. 1, věta čtvrtá). Pro centrová léčiva (ATC L01 onkologika, L04 imunosupresiva, B02 hemostatika, atd.) je úhrada vázána na **specializované pracoviště** (§ 15 odst. 11) — výlučně **center vysoce specializované péče** jmenovaná MZd.

## § 39d — Vysoce inovativní léčivý přípravek (VILP)
...
§ 39d je **„managed entry" mechanismus** — způsob, jak rychle umožnit hrazenou léčbu **průlomovým inovacím** dříve, než budou k dispozici robustní real-world data. Místo standardního řízení o trvalé úhradě (§ 39g–h) probíhá zkrácené řízení o **dočasné úhradě 3+2 roky**.

#### Definice VILP (odst. 2)

Léčivý přípravek je **vysoce inovativní**, pokud:

| Podmínka onemocnění | Důkazní požadavek |
|---|---|
| trvalá/dlouhodobá hospitalizace; opakované hospitalizace; invalidita; trvalé poškození zdraví; ztráta zraku/sluchu/řeči/pohybu; zkrácení života > 20 % | + alespoň jeden z následujících klinických přínosů: |
| | a) ≥ 30 % zlepšení v primárním klinickém cíli s dopadem na kvalitu života (≥ 35 % při nepřímém srovnání), nebo prodloužení PFS ≥ 3 měsíce |
| | b) prodloužení mediánu OS ≥ 30 % (min. 3 měsíce), nebo snížení HR celkového přežití ≥ 35 % |
| | c) přípravek s **podmínečnou registrací** dle nařízení (ES) 726/2004 bez alternativy, se závazkem výrobce uhradit náklady při zrušení registrace |

Typickými VILP jsou **onkologika s prokazatelným klinickým přínosem nad rámec standardní léčby**, nové **antivirotika** (např. proti HCV), **moderní antidiabetika a antikoagulancia** s důkazem snížení kardiovaskulárního rizika atd.

#### Mechanismus dočasné úhrady (odst. 3)

- **Doba: 3 roky + případně další 2 roky** (max. 5 let);
- **Úhrada dle § 39c odst. 2** (referenční srovnání), nepoužije se § 39c odst. 7 a 8 (běžná pravidla základní úhrady RS);
- **Nepožaduje se nákladová efektivita** jako podmínka účelné terapeutické intervence (§ 15 odst. 7) — tj. cena na QALY může být nad standardním prahem 1,2 mil. Kč;
- **Vždy podmínka použití na specializovaném pracovišti** (§ 15 odst. 11);
- Žádost o **druhou** dočasnou úhradu min. **6 měsíců** před koncem první.

#### Smlouva o sdílení rizik (odst. 4 a 6) — „managed entry agreement"

Specializované pracoviště musí ZP **odevzdávat data o reálném použití** (real-world data) — účinnost, výsledky léčby. Náklady ZP **nesmí překročit částku dohodnutou ve smlouvě** mezi držitelem registrace a ZP („cap"); v opačném případě **držitel doplácí přebytek**. Smlouva se uzavírá s každou ZP, která o ni požádá, do 12 měsíců.

#### Právo na doléčení (odst. 7)

Klíčová **pacientská záruka**: po skončení dočasné úhrady, jestliže přípravek nezíská trvalou úhradu (nebo dostane úhradu s užším indikačním omezením), má pojištěnec **právo být doléčen na náklady držitele** — až **24 měsíců** nebo do převedení na alternativu hrazenou ze ZP. Bez tohoto pravidla by „skok mimo úhradu" znamenal pro pacienta uprostřed terapie ekonomickou katastrofu (cena VILP zpravidla 100 000 – 1 mil. Kč měsíčně).

#### Kombinační VILP (odst. 12–13)

Při použití dvou VILP **v kombinaci** musejí oba držitelé podat žádost společně (do 30 dnů od první). Ústav vede **společné řízení** a stanoví **shodné podmínky úhrady** pro oba přípravky. Obchodní tajemství jednoho držitele zůstává druhému utajeno (přístup má jen Ústav a MZd).

## § 39da — Léčivé přípravky pro vzácná onemocnění (orphan drugs)
...
§ 39da (přidán novelou 371/2021 Sb., účinný od **1. 1. 2022**) řeší **léčiva pro vzácná onemocnění** (orphan medicinal products). Definici přebírá z **nař. (ES) č. 141/2000** — onemocnění s prevalencí ≤ 5 na 10 000 osob v EU. Tyto léčiva jsou typicky **velmi drahá** (často 1–10 mil. Kč ročně na pacienta) a postihují malé skupiny — klasická HTA založená na poměru ICER/QALY je metodicky nevhodná.

#### Klíčové odlišnosti od standardního řízení

| Prvek | § 39g–h (běžné) | § 39da (orphan) |
|---|---|---|
| **Rozhoduje** | Ústav (SÚKL) | Ústav, ale klíčové slovo MZd skrze **závazné stanovisko** dle § 149 SŘ |
| **Účast** | žadatel, držitel registrace, ZP | + **příslušná odborná společnost** + **pacientská organizace** |
| **Poradní orgán** | – | **Poradní orgán pro vzácná onemocnění** (paritně: MZd, ZP, odborné společnosti, pacientské organizace) |
| **Nákladová efektivita** | povinné kritérium | analýza CEA se předkládá, ale **bez zohlednění ICER/QALY výsledku** |
| **Doba úhrady** | trvalá | trvalá, ale s **revizí po 3 letech** a **přehodnocením po 1 roce** na žádost ZP |

#### Posuzovací kritéria (odst. 3)

Orphan systém zohledňuje navíc:

- **Celospolečenský význam možnosti terapeutického ovlivnění onemocnění** — etický rozměr
- **Reálné možnosti zajištění léčby v síti PZS** — některá orphan léčba (genová, ATMP) vyžaduje vysoce specializovaná centra (v ČR často 1–2 pracoviště)
- **Pacientskou perspektivu** prostřednictvím účasti pacientské organizace v řízení

#### Poradní orgán a závazné stanovisko (odst. 5–7)

MZd zřizuje paritní poradní orgán; ten posuzuje hodnotící zprávu SÚKL a kritéria. Členové na 3 roky, jmenuje ministr. MZd na základě projednání vydá **závazné stanovisko** (§ 149 SŘ):

- a) **souhlas** s podmínkami v hodnotící zprávě,
- b) **návrh jiné výše nebo podmínek** (žadatel může nesouhlasit a tím řízení zastavit),
- c) **nesouhlas** s úhradou.

V případě nesouhlasu může žadatel novou žádost podat **nejdříve po 6 měsících**.

#### Smluvní mechanismus omezení rozpočtového dopadu (odst. 8)

Stejně jako u VILP musí držitel uzavřít s ZP smlouvu o **stropu nákladů**; náklady nad tento strop hradí držitel.

#### Doléčení (odst. 12)

Při zrušení úhrady po revizi má pojištěnec právo na úhradu **doléčení po dobu max. 12 měsíců** ze strany ZP (kratší období než u VILP — předpokládá se přechod na alternativu).

## § 39db — Léčivé přípravky určené k imunizaci (vakcíny)
...
§ 39db (rovněž novela 371/2021 Sb.) je **paralelní zvláštní řízení pro vakcíny**, kde se vedle běžných farmakoekonomických parametrů zohledňují **epidemiologické a veřejnozdravotní dopady**.

#### Specifické rysy

| Prvek | Detail |
|---|---|
| **Účastníci** | + **Česká lékařská společnost J. E. Purkyně** (povinný účastník) |
| **Vyjádření Státního zdravotního ústavu (SZÚ)** | do 30 dnů od zahájení; SZÚ se opírá o **Národní imunizační komisi**; Ústav se může odchýlit jen s odůvodněním |
| **Posuzovaná kritéria** | navíc: **imunogenita**, kolektivní imunita, předcházení ohrožení veřejného zdraví, podpora zdraví |
| **Cena pro spotřebitele** | úhrada navržena tak, aby se rovnala maximální ceně pro konečného spotřebitele (tj. **nulový doplatek**) |
| **Poradní orgán pro imunizaci** | 2 zástupci MZd, 2 ZP, 2 odborné společnosti + předseda = **hlavní hygienik ČR** |
| **Žádné revize** | u vakcín se **neprovádí** zkrácená ani hloubková revize (odst. 12) — místo toho přehodnocení MZd při významné změně epidemiologie |

#### Praktický význam

Tento režim řeší vstup nepovinných hrazených vakcín do systému (např. **HPV, pneumokoky, meningokoky, hexavakcína** v různých variantách) i krizové vakcíny (covid-19, monkeypox). Povinné očkování dle zákona o ochraně veřejného zdraví funguje paralelně — § 39db řeší úhradu, nikoli povinnost.

## § 39e — Úhradová soutěž (elektronická aukce)

> *(1) Za účelem zajištění plně hrazených léčivých přípravků a úspor prostředků zdravotního pojištění může Ústav vypsat soutěž o nejnižší úhradu léčivého přípravku (dále jen „úhradová soutěž"), pokud o její vypsání požádá zdravotní pojišťovna.*

**Výklad:**

§ 39e je **e-aukční mechanismus** zavedený jako moderní nástroj snižování úhrad. Žádá ZP, vypisuje SÚKL, podmínkou jsou min. **3 různí držitelé registrace** pro danou LL a lékovou formu.

#### Pravidla soutěže

| Fáze | Pravidlo |
|---|---|
| **Zahájení** | žádost ZP + souhlas MZd, oznámení ve Věstníku SÚKL |
| **Kvalifikace** | jen držitel dostupného přípravku dle § 39c odst. 2 písm. a), bez přestupku za 3 roky |
| **Aukce** | **1 kolo, elektronicky, min. 30 minut**; minimální snížení 1 % základní úhrady ODTD |
| **Vítězná hodnota** | musí být **alespoň o 2 % nižší** než zahajovací hodnota — jinak se soutěž zastaví |
| **Závazek vítěze** | dodávat na trh **18 měsíců** za přijatou cenu, min. **polovinu spotřeby** RS za předchozích 18 měsíců |
| **Důsledek pro ostatní** | úhrada všech ostatních přípravků v LL/LF klesne na **75 % přijaté aukční hodnoty** — silný cenový tlak na konkurenty |

Po 10 měsících od vykonatelnosti lze vyhlásit další soutěž; vítěz minulé může své vítězství „prodloužit" o 18 měsíců, pokud nikdo nenabídne nižší cenu.

> 📌 **Praktická aplikace:** soutěž se v praxi využívá relativně omezeně — k jejím limitům patří nutnost min. 3 nezávislých dodavatelů a riziko, že silný hráč po vítězství stáhne investice do ČR. Zavedení (od 2019) přesto výrazně snížilo úhrady u některých generických tříd (proton-pump inhibitory, vybraná antihypertenziva).

## § 39f — Žádost o stanovení maximální ceny a úhrady

> *(1) Žádost o stanovení maximální ceny nebo žádost o stanovení výše a podmínek úhrady se podává jednotlivě pro každou lékovou formu léčivého přípravku.*
...
- **Dovozce nebo tuzemský výrobce** neregistrovaného přípravku v rámci specifického léčebného programu (§ 49 zák. o léčivech),
- **Zdravotní pojišťovna** (může žádat i o snížení úhrady).

#### Řízení z moci úřední (odst. 4)

Ústav zahájí řízení ex officio, je-li to ve **veřejném zájmu** (§ 17 odst. 2), u **imunizačních přípravků** vždy, je-li to nezbytné z důvodu ochrany veřejného zdraví.

#### Náležitosti žádosti (odst. 5–6)

- Identifikace, název přípravku, léková forma, balení;
- **Indikace**, pro něž je úhrada navrhována;
- **Kvantifikovatelné cíle farmakoterapie** (písm. e);
- **ODTD a definovaná denní dávka** dle WHO;
- Navrhovaná výše úhrady a maximální ceny;
- **Klinická hodnocení**, **CEA**, **BIA**, **farmakoekonomické modely**;
- **Mezinárodní cenový seznam** (ČS EU s výší ceny a úhrady);
- **Předběžná ujednání s ZP** (memoranda) ve veřejném zájmu.

#### Ochrana obchodního tajemství (odst. 11–12)

Žadatel může označit části dokumentace za **obchodní tajemství** dle § 504 občanského zákoníku. Nesmí se označit (taxativně dle odst. 11): obchodní název, identifikace žadatele, cíle farmakoterapie, složení neregistrovaného přípravku, dávkování, výsledky klinických hodnocení, ceny v EU, písemná ujednání s ZP.

Naopak **lze** chránit (odst. 12): smluvní ujednání o limitaci dopadu (cap), parametry vlivu na CEA/BIA, farmakoekonomické modely. Tyto informace zná pouze Ústav, MZd a smluvní strany.

#### Náhrada výdajů SÚKL (odst. 13–18)

Žadatel hradí Ústavu **správní poplatek** za odborné úkony (specifikace ve vyhlášce MZd). Nehradí ZP, orphan drugs, žadatelé o zvýšení ceny ve veřejném zájmu, specifické léčebné programy. Náhrady jsou **příjmem SÚKL** (mimo státní rozpočet), součástí rezervního fondu — vláda však může nařídit převod do státního rozpočtu MZd.

## § 39g — Řízení o stanovení maximální ceny a úhrady
...
§ 39g definuje **procesní rámec** standardního řízení. Klíčové prvky:

| Prvek | Specifikum |
|---|---|
| **Lhůta** | **75 dnů** (úhrada), **165 dnů** (společné řízení o ceně + úhradě) — recipuje **Transparenční směrnici 89/105/EHS** (čl. 6: max. 90/180 dnů) |
| **Účastníci** | žadatel, ZP, držitel registrace, dovozce/výrobce neregistrovaného |
| **Důkazy** | 15 dnů od zahájení k podání návrhů |
| **Vyjádření k podkladům** | 10 dnů od sdělení o ukončení zjišťování |
...
Tento mechanismus umožňuje **diferencovanou úhradu mezi ZP** — což je výjimkou ze zásady jednotnosti systému. Slouží zejména u centrových léčiv, kde si pojišťovna může vyjednat individuální slevu výměnou za garantovaný objem (managed entry agreement na úrovni ZP).

## § 39h — Rozhodnutí, výpočet konečné úhrady, vykonatelnost

> *(1) Léčivý přípravek je hrazen ve výši určené součtem stanovené úhrady, maximální výše obchodních přirážek a daně z přidané hodnoty (dále jen „nejvyšší možná úhrada pro konečného spotřebitele"), maximálně však do výše skutečně uplatněné ceny pro konečného spotřebitele.*

**Výklad:**

Klíčová **kalkulační formule** úhrady pro koncového spotřebitele:

```
úhrada pro spotřebitele = úhrada (Ústav)
                       + max. obchodní přirážka
                       + DPH
...
ZÚLP účtovaný spolu se zdravotním výkonem ZP je hrazen:

- a) ve výši **nejvyšší možné úhrady** pro spotřebitele,
- b) ve výši **nejvyšší možné ceny** pro spotřebitele, je-li nižší,
- c) ve výši **smluvní ceny ZP**, je-li nejnižší.

Hierarchie b) → c): cena je vždy ≤ úhrady; smluvní cena ZP **dále** snižuje úhradu pro PZS, který je smluvním partnerem dané ZP.

#### Vykonatelnost rozhodnutí (odst. 3)

Rozhodnutí o úhradě se uplatní vydáním **nejbližšího Seznamu SÚKL** (§ 39n) — k 27. dni měsíce — pokud nabude právní moci do **15.** dne měsíce; jinak až **druhým** následujícím seznamem.

#### Odkladný účinek odvolání (odst. 4)

**Odvolání nemá odkladný účinek**; rozhodnutí je předběžně vykonatelné. Tento prvek je výrazně **proodvolatelný** — i kdyby se rozhodnutí později zrušilo, mezitím se podle něj fakticky hradí. Cílem je, aby spory netrvaly měsíce v limbu.

## § 39i — Změny maximální ceny a úhrady

**Výklad:**

§ 39i řeší **revize jednotlivých přípravků** (oproti § 39l hloubkové revizi RS):

- Změna na žádost: může podat držitel, dovozce/výrobce neregistrovaného, ZP (ta jen je-li současná cena vyšší než výpočet dle § 39a, nebo k úhradě obecně);
- **Z moci úřední**: Ústav neprodleně zahájí řízení, neodpovídá-li úhrada základní úhradě RS dle § 39c odst. 7, nebo má nesprávné podmínky úhrady;
- **Vládní stabilizační opatření** (odst. 3): k zajištění finanční stability ZP může Ústav úhrady snižovat — postupně od částečně hrazených k život zachraňujícím (řízeným hierarchickým postupem, aby se nejdříve šetřilo tam, kde to nejméně ohrožuje pacienty).

V řízení **nelze stanovit více omezující podmínky** úhrady, než jaké byly v poslední hloubkové revizi (odst. 4) — ochrana proti administrativnímu „přitvrzování" mimo režim § 39l.

## § 39j — Zrušení a zánik maximální ceny a úhrady

**Výklad:**

Důvody **zrušení** úhrady:

| Důvod | Iniciátor | Předpoklady |
|---|---|---|
| nedodávání na trh > 12 měsíců | žadatel/Ústav | + zrušení není v rozporu s dostupností péče |
| nesoulad se zákonem (ZP) | ZP | nelze dosáhnout změnou |
| nevhodnost klinického použití | Ústav | držitel neprokáže opak |
| u kombinace VILP/orphan zrušení úhrady druhého | Ústav | automaticky |

**Zánik** je odlišný — nastává **ex lege**:

- zrušení/zánik registrace přípravku (dnem zrušení nebo uplynutím doby pro postupné stažení),
- ukončení specifického léčebného programu u neregistrovaných,
- uplynutí doby dočasné úhrady VILP bez stanovení trvalé úhrady.

Sankční prvek (odst. 3): při přestupku § 44 odst. 3 lze úhradu zrušit + až na **3 roky zakázat podání nové žádosti** o úhradu dotčeného přípravku.

## § 39k — Mimořádné prodloužení lhůty

Krátké procedurální ustanovení: při „mimořádně velkém počtu žádostí" může Ústav lhůtu dle § 39g odst. 2 prodloužit **o 60 dnů** (pouze jednou). Žadateli a osobám dle § 39f odst. 2 písm. a) a b) musí oznámit před uplynutím.

## § 39l — Hloubková revize úhrad
...
Hloubková revize = **komplexní přezkum celé referenční skupiny**. Ústav v ní:

- mění **základní úhradu** RS,
- harmonizuje úhrady všech přípravků s touto základní úhradou,
- přehodnocuje **podmínky úhrady** (preskripce, indikace),
- ověřuje **soulad s plněním cílů farmakoterapie a CEA**.

#### Periodicita

- **První hloubkovou revizi** Ústav zahájí **do 3 let** od vykonatelnosti rozhodnutí o úhradě prvního přípravku v RS.
- **Mezi dvěma hloubkovými revizemi** musí uplynout min. **12 měsíců**.

#### Dramatický pokles základní úhrady (odst. 3, věta druhá)

Při poklesu základní úhrady o **více než 80 %** (typicky vstup masivní generické konkurence) Ústav v revizi:

- u **receptových RS** zruší indikační omezení (vyjma indikací mimo SPC dle § 39b odst. 3) a přehodnotí preskripční omezení,
- u **ZÚLP RS** přehodnotí indikační omezení.

Logika: jsou-li léky levné, není důvod omezovat předepisování.

## § 39n — Zveřejňování (Seznam SÚKL)

> *(1) Ústav vydává k dvacátému sedmému dni kalendářního měsíce seznam s platností od prvního dne následujícího kalendářního měsíce, který zveřejňuje na elektronické úřední desce.*

**Výklad:**

**Seznam SÚKL** = nejdůležitější právní akt v lékové oblasti, **vydávaný měsíčně** k 27. dni s platností od 1. dne následujícího měsíce. Obsahuje:

- u **hrazených přípravků**: výši ohlášené ceny / maximální ceny, výši a podmínky úhrady, nejvyšší možnou úhradu pro spotřebitele, **doplatek započitatelný do limitu dle § 16b**;
- **základní úhrady referenčních skupin** s odůvodněním;
- **maximální ceny přípravků**, u nichž Ústav rozhoduje jen o ceně (nikoli úhradě).

**Předběžný návrh** seznamu zveřejňuje SÚKL k **20.** dni měsíce; do předposledního dne se k němu lze vyjádřit.

#### Komunikace s EU Komisí (odst. 4)

SÚKL **jedenkrát ročně** poskytuje Komisi seznamy léčiv (stanovené ceny, navýšené ceny, hrazené přípravky) — recipuje povinnost dle **Transparenční směrnice 89/105/EHS**.

#### Obchodní tajemství (odst. 5–7)

Ústav zveřejňuje **spisy** správních řízení dálkovým přístupem — vyjma údajů označených jako obchodní tajemství dle § 39f odst. 11/12. Informace s obchodním tajemstvím mohou být sdíleny **jen** s MZd, soudy, OČTŘ, EU Komisí. Pokud žadatel dodatečně sám zveřejní označenou informaci, ztrácí ochrana platnost.

## § 39o — Doručování v řízeních dle části šesté
...
Atypické pravidlo: doručování **výhradně elektronickou veřejnou vyhláškou** (úřední deska SÚKL); písemnost se považuje za doručenou **5. dnem** po vyvěšení. Důvod: u mnoha řízení s velkým počtem účastníků (desítky držitelů registrace) by individuální doručování bylo nepraktické.

## § 39p — Zkrácená revize maximálních cen nebo úhrad

> *(1) Ústav provádí zkrácenou revizi, ve které přezkoumává a v případě potřeby mění výši maximálních cen, výši základní úhrady a soulad výší úhrad všech v zásadě terapeuticky zaměnitelných léčivých přípravků se základní úhradou.*

**Výklad:**

**Zkrácená revize** = rychlejší revize zaměřená pouze na **cenu a úhradu**, nikoli podmínky úhrady. Provádí se z moci úřední nebo na žádost ZP, je-li **předpokládaná úspora**:

| Typ RS | Práh úspory |
|---|---|
| **ZÚLP** | > 20 mil. Kč ročně |
| **Receptové** | > 30 mil. Kč ročně |

Dále se zahajuje:

- automaticky, není-li ve skupině přílohy č. 2 ani 1 plně hrazený přípravek (odst. 2 — provedení „jeden plně hrazený" pravidla),
- na základě **písemného ujednání** dle § 39c odst. 2 písm. c)/d), je-li úspora ≥ 20 mil. Kč,
- při **porušení takového ujednání**, nebo pokud po 6 měsících od jeho účinnosti není přípravek dostupný.

Lhůta pro vydání: **50 dnů** od zahájení. Podmínkou je, že v RS proběhla **alespoň jedna hloubková revize**; jinak Ústav nejprve provede hloubkovou revizi.

## ČÁST SEDMÁ — Kategorizace a cenová a úhradová regulace zdravotnických prostředků předepsaných na poukaz

### Úvodní souvislosti

Část sedmá (§§ 39r–39z) byla **zcela nově zavedena** novelou **č. 282/2018 Sb.** s účinností od **1. 1. 2019**. Před tím byla úhrada zdravotnických prostředků **na poukaz** (kompenzační, ortopedické, inkontinenční pomůcky atd.) řešena **přílohou č. 3 zákona** s mimořádně podrobným seznamem, který bylo nutno měnit zákonem — což bylo **rigidní a neflexibilní**.

Reforma:

- **Ohlašovací (notifikační) princip** — výrobce/ohlašovatel **ohlásí** prostředek SÚKL, ten se posléze automaticky zařadí do **úhradové skupiny** (pokud Ústav nezahájí řízení o opaku);
- **Kategorizační strom** definovaný **zákonem č. 89/2021 Sb., o zdravotnických prostředcích** (samostatným zákonem) — jasné rozlišení skupin (sluchadla, ortopedické pomůcky, glukometry, inkontinenční pomůcky atd.) s úhradovými limity v korunách na měrnou jednotku;
- **Cenová soutěž** dle § 39w–y jako analogie e-aukce z § 39e (zdravotní pojišťovny → SÚKL → aukce);
- **Dohoda o nejvyšší ceně** se závazkem dodávek (§ 39v) jako alternativa k aukci.

### Pojmosloví části sedmé

| Pojem | Definice |
|---|---|
| **Zdravotnický prostředek na poukaz** | prostředek hrazený ze ZP a předepisovaný lékařem na lékařský poukaz (paralela receptu) |
| **Ohlašovatel** | výrobce, jeho zplnomocněný zástupce ze třetí země, nebo jím pověřená osoba — vždy **jen jeden** subjekt pro daný prostředek |
| **Úhradová skupina** | skupina prostředků se shodným úhradovým limitem dle kategorizačního stromu (zákon 89/2021 Sb.) |
| **Skupina zaměnitelných prostředků** | podmnožina úhradové skupiny tvořená Ústavem (§ 39u) pro účely cenové soutěže nebo dohody se závazkem |
| **Cena původce** | cena, za kterou je prostředek **poprvé dodáván v rámci distribučního řetězce na trh ČR**, bez obchodní přirážky a DPH |
| **Úhradový limit** | strop úhrady v Kč na měrnou jednotku, stanovený v zákoně 89/2021 Sb. pro každou úhradovou skupinu |

## § 39r — Ohlašování zdravotnických prostředků
...
Ohlášení probíhá **výhradně elektronicky** přes **Informační systém zdravotnických prostředků (RZPRO)** zřízený dle zákona č. 89/2021 Sb. Ohlášení obsahuje:

- identifikaci výrobce, případně zplnomocněného zástupce ze třetí země nebo pověřené osoby (jen **jeden** subjekt),
- jedinečný registrační/identifikační kód (UDI-DI dle nař. EU 2017/745 nebo 2017/746),
- obchodní název a popis variant/konfigurací,
- **úhradovou skupinu** a případně skupinu zaměnitelných prostředků,
- **cenu původce** pro každou variantu,
- **předpokládanou výši úhrady** dopočtenou dle zákona 89/2021 Sb.,
- u tzv. „**nekategorizovaných zdravotnických prostředků**" (50 %): souhlas MZd; u 100 %: smlouva o sdílení rizik se všemi ZP.

#### Přílohy k ohlášení (odst. 8)

- návod k použití v ČJ,
- prohlášení o shodě (česky/anglicky),
- platný **certifikát notifikované osoby** (pro prostředky tříd IIa, IIb, III, IVD třídy B–D, sterilní/měřící I),
- závěrečnou zprávu o **klinickém hodnocení** dle čl. 77 odst. 5 nař. 2017/745 (resp. čl. 56 odst. 5 nař. 2017/746),
- aktuální ceník v EU + překlad,
- u **nekategorizovaných** prostředků **hodnocení nákladové efektivity a dopadu**.

#### Změny údajů (odst. 6)

Ohlašovatel je povinen ohlásit změnu (mimo zvýšení ceny) **do 30 dnů**. Zvýšení ceny lze uplatnit teprve **po zveřejnění v seznamu** (§ 39t).

#### Nekategorizované zdravotnické prostředky (odst. 5 písm. j, k, 7)

Pokud prostředek **nespadá** do žádné existující úhradové skupiny:

- **úhrada 50 %**: vyžaduje **souhlas MZd** po posouzení veřejného zájmu a CEA;
- **úhrada 100 %**: vyžaduje **smlouvu o sdílení rizik** se **všemi ZP** s ročním nákladovým stropem.

Tento mechanismus umožňuje pružný vstup inovativních pomůcek (např. nový typ inzulinové pumpy, kontinuální monitor glykémie), které nejsou ve stávajícím kategorizačním stromě.

## § 39s — Zařazování do úhradových skupin
...
Klíčový **mlčenlivý souhlas (silent consent)**: nezasáhne-li Ústav do **45 dnů** od zveřejnění ohlášení, prostředek **se automaticky zařazuje** do navržené úhradové skupiny. Ústav zveřejňuje ohlášení k **10. dni** měsíce; lhůta 45 dnů + nabytí účinnosti k **prvnímu dni druhého následujícího měsíce**.

#### Důvody vyřazení (odst. 4)

| Důvod | Příklad |
|---|---|
| nesoulad s úhradovou skupinou | změna vlastností prostředku |
| odvolání souhlasu MZd | u nekategorizovaných |
| uplynutí smlouvy o sdílení rizik | u 100% úhrady |
| **bez úhrady ze ZP > 12 měsíců** | prostředek se reálně neužívá |
| stažení z trhu / bezpečnostní opatření | recall, hlášení nežádoucích příhod |
| pozastavení/zánik certifikátu notifikované osoby | např. po Brexit-přechodech |
| nesprávné ohlášení nebo neohlášené zvýšení ceny | sankce za procesní porušení |

**Odvolání proti vyřazení nemá odkladný účinek** (odst. 7) — chrání systém před zneužitím obstrukcí.

## § 39t — Zveřejňování (Seznam zdravotnických prostředků)

**Výklad:**

Paralela k Seznamu SÚKL pro léčiva. **Seznam zdravotnických prostředků hrazených na poukaz** se zveřejňuje k **24. dni měsíce** s platností od následujícího měsíce. Obsahuje:

- identifikaci ohlašovatele, UDI-DI, kódy SÚKL pro varianty,
- výši úhrady (vč. DPH),
- **preskripční, indikační, množstevní/frekvenční omezení** dle zákona 89/2021 Sb.,
- maximální konečnou cenu (cena původce + max. přirážka + DPH),
- informaci o **pozbytí platnosti rozhodnutí** dle § 39v odst. 3 nebo § 39x odst. 7.

#### Výpočet úhrady (odst. 4)

```
úhrada ≤ skutečná cena (vč. obchodní přirážky a DPH)
        ≤ úhradový limit (zákon 89/2021 Sb.) + DPH    nebo
          cena z dohody dle § 39v + DPH                nebo
          přijatá aukční hodnota dle § 39x + DPH
```

Tj.: úhrada je **dvojí strop**: vždy max. skutečná cena **a současně** max. zákonný/dohodnutý/aukční limit.

## § 39u — Skupiny zaměnitelných prostředků

**Výklad:**

§ 39u zavádí **podstrukturu uvnitř úhradové skupiny** — **skupiny zaměnitelných prostředků**. Cílem je vytvořit menší jednotky pro účely:

- **Dohody o nejvyšší ceně se závazkem** dle § 39v odst. 3,
- **Cenové soutěže** dle § 39w (vyžaduje pojišťovny zastupující ≥ 30 % pojištěnců).

Ústav rozhoduje na žádost ZP do **90 dnů**. Účastníky jsou všechny ZP a všichni ohlašovatelé dané úhradové skupiny. Nezůstane-li v zaměnitelné skupině žádný prostředek, Ústav ji zruší.

## § 39v — Dohoda o nejvyšší ceně

> *(1) Zdravotní pojišťovna a ohlašovatel mohou ve veřejném zájmu podle § 17 odst. 2 uzavřít písemné ujednání obsahující závazek ohlašovatele dodávat zdravotnické prostředky zařazené do úhradové skupiny, popřípadě skupiny zaměnitelných prostředků, za cenu uvedenou v ujednání (dále jen „dohoda o nejvyšší ceně").*

**Výklad:**

§ 39v zavádí **bilaterální cenová dohoda mezi ZP a ohlašovatelem**. Dvě varianty:

| Typ | Charakter |
|---|---|
| **Prostá dohoda** (odst. 1) | závazek ohlašovatele nepřekročit smluvní cenu — vztahuje se na všechny dodávky |
| **Dohoda se závazkem dodávek** (odst. 3) | + závazek dodávat **min. polovinu spotřeby** RS za 1 kalendářní rok zpětně — bez možnosti výpovědi v 1. roce |

#### Mechanismus dočasného snížení úhrady (odst. 3)

U dohody se závazkem Ústav zahájí řízení o **dočasném snížení úhrady pro skupinu zaměnitelných prostředků** na cenu z dohody (přepočtenou dle parametrů ze zákona 89/2021 Sb.). Obdrží-li v 20 dnech od oznámení další dohody se závazkem, vybere tu s **nejnižší cenou**. Dohoda na **1 rok**, prodloužitelná o 1 rok.

#### Důsledky (odst. 7, 8)

- po dobu platnosti rozhodnutí o dočasném snížení **nelze zahájit cenovou soutěž** v té úhradové skupině,
- prostředky dle dohody se **nezahrnují do regulačních omezení** vůči poskytovateli,
- ZP **podpoří jejich předepisování** smluvní politikou.

#### Sankce za porušení dohody (odst. 9)

Při pravomocném rozhodnutí o přestupku dle § 44 odst. 1 písm. b) (porušení závazku dodávat) se úhrada vrátí na **standardní úhradový limit** ze zákona 89/2021 Sb.; dohoda pozbývá platnosti k 1. dni druhého následujícího měsíce.

## § 39w–§ 39x — Cenová soutěž
...
§ 39w–x je **e-aukční mechanismus pro zdravotnické prostředky**. Strukturně podobný § 39e (úhradová soutěž léčiv), ale:

| Prvek | Detail |
|---|---|
| **Iniciátor** | ≥ 1 ZP zastupující ≥ **30 %** pojištěnců |
| **Předpoklad úspory** | ≥ **5 %**, min. **1 mil. Kč ročně** v rámci úhradové skupiny |
| **Souhlas MZd** | povinný (veřejný zájem dle § 17 odst. 2) |
| **Min. počet účastníků** | **3** v jedné skupině zaměnitelných prostředků |
| **Trvání aukce** | **min. 30 min.**, 1 kolo, prodlužování o 1 min. po každém podání po 29. min. |
| **Přijatá aukční hodnota** | **druhá nejnižší** (!!) cena — proti spekulativním nabídkám „za 0 Kč" |
| **Min. úspora** | druhá nejnižší musí být **≥ 10 %** pod zahajovací hodnotou (jinak soutěž zastavena) |
| **2 výherci** | účastníci s 2 nejnižšími nabídkami |
| **Závazek** | dodávat **12 měsíců** za přijatou aukční hodnotu (= druhou nejnižší), min. **třetina spotřeby** RS za předchozí kalendářní rok |

#### Důsledky (§ 39y)

- Všechny v zásadě zaměnitelné prostředky ve skupině se hradí dle **přijaté aukční hodnoty**;
- Prostředky výherců se **nezahrnují do regulačních omezení** PZS;
- Při porušení závazku (přestupek § 44 odst. 2) se úhrada vrací na standardní úhradový limit.

#### Specifický motiv „druhé nejnižší ceny"

Mechanismus „druhé nejnižší vyhrává cenu" je **anti-dumpingový**: znemožňuje strategické podsekání trhu nesmyslnou nabídkou pod cost level. Současně dva výherci zajišťují **diverzifikaci dodavatelského řetězce** — pokud jeden selže, druhý zajistí kontinuitu.

## § 39z — Doručování a vykonatelnost v řízeních podle části sedmé

Paralela § 39o pro část sedmou:

- doručování pouze **veřejnou vyhláškou na elektronické úřední desce SÚKL**,
- doručeno **5. dnem** po vyvěšení,
- vykonatelnost: do **10.** dne měsíce → nejbližší seznam; po 10. dni → druhý nejbližší seznam (§ 39t odst. 1).

## ČÁST OSMÁ — Kategorizace a cenová a úhradová regulace potravin pro zvláštní lékařské účely (FSMP)

### Úvodní souvislosti

Část osmá (§§ 39za–39zj) je **nejnovější** kategorizační vrstvou — zavedena novelou **č. 371/2021 Sb.** s plnou účinností od **1. 1. 2024** (s přechodným režimem 2022–2023). Reaguje na to, že **potraviny pro zvláštní lékařské účely** (Food for Special Medical Purposes, FSMP) — enterální výživy, vysokoproteinové diety pro CHOPN, polymery pro PEG, fenylketonurické diety atd. — byly historicky regulovány analogicky k léčivům dle části šesté, což bylo přehnaně složité pro produkty s objektivně jiným profilem.

Reformou se přebírá architektura části sedmé:

- **ohlašovací (notifikační) princip** ohlašovatelem (výrobce/dovozce),
- **úhradové skupiny** definované **přílohou č. 6 zákona** (s odlišnou strukturou pro standardní vs. nutričně upravené, kompletní vs. nekompletní výživu),
- **opatření obecné povahy** SÚKL pro stanovení **základní úhrady** za referenční jednotku,
- **smluvní mechanismy** mezi ZP a ohlašovatelem (§ 39zf),
- **nekategorizované potraviny** s individuálním rozhodováním SÚKL (§ 39zg) — paralela nekategorizovaných ZP.

## § 39za — Zásady regulace FSMP
...
Základní pravidlo: FSMP se hradí jen v **ambulantní péči** (lůžková péče je pokryta v rámci úhrady PZS), předepsáním na **lékařský předpis** (zvláštní recept), za splnění podmínek **přílohy č. 6 zákona** nebo SÚKL u nekategorizovaných.

#### Dělení FSMP

| Typ | Definice (odst. 2) | Příklad |
|---|---|---|
| **Kategorizovaná potravina** | náleží do úhradové skupiny dle přílohy č. 6 | Nutrison, Resource, Renilon, Phenyl Free atd. |
| **Nekategorizovaná potravina** | nenáleží do žádné skupiny — SÚKL stanovuje individuálně dle § 39zg | nové polymery, speciální formule |

#### Úplná vs. částečná enterální výživa (odst. 4)

Klíčový rozdíl:

- **Úplná enterální výživa (ÚEV)**: jediný zdroj výživy pacienta (typicky PEG, nasogastrická sonda, kompletně sipping diety u CHOPN nebo onkologie);
- **Částečná enterální výživa (ČEV)**: doplněk běžné stravy.

**Stejná výše úhrady za balení** pro obě indikace, **ale jiný počet hrazených balení za den**: počítá se jako podíl referenčních jednotek v množstevním omezení a referenčních jednotek v balení. Tj. ÚEV pacient dostane víc balení.

Předepisuje-li lékař ÚEV, **musí uvést „zvýšená úhrada"** na recept (odst. 9).

#### Regulace cen (odst. 7)

| Typ | Regulace ceny |
|---|---|
| **Nekategorizovaná** | maximální cena výrobce (analogie § 39a) |
| **Kategorizovaná** | **oznámená cena výrobce** + **věcné usměrnění ceny** dle cenového výměru MZd (max. meziroční zvýšení) |

Oznámená cena = cena, za kterou výrobce hodlá uvádět produkt na trh. Je-li ohlášena, **lékárny ji nesmí překročit** o víc než povolenou obchodní přirážku.

#### Záměnnost v lékárně (odst. 10)

Lékárník může vydat:

- jinou **variantu téže** FSMP se souhlasem pacienta,
- jinou **FSMP ze stejné úhradové skupiny** se souhlasem předepisujícího lékaře nebo pacienta — za podmínky shodné/obdobné energetické hodnoty a obsahu živin.

To zajišťuje praktickou zaměnitelnost při výpadcích dodávek konkrétních variant.

## § 39zb — Seznam hrazených potravin

**Výklad:**

Paralela Seznamu SÚKL pro FSMP. Zveřejňuje se k **25. dni měsíce** s platností od následujícího měsíce. U každé varianty FSMP obsahuje:

- výši úhrady (vč. DPH),
- preskripční/indikační/množstevní omezení dle přílohy č. 6,
- úhradovou skupinu, referenční jednotku, počet referenčních jednotek v balení,
- maximální/oznámenou cenu výrobce (i přepočtenou na referenční jednotku),
- **základní úhradu úhradové skupiny**,
- označení, zda FSMP splňuje podmínky ÚEV nebo ČEV nebo obojího.

## § 39zc — Ohlášení FSMP

**Výklad:**

Procesně paralela § 39r:

- ohlášení **elektronicky** Ústavu,
- pro **jednotlivou variantu** (velikost balení, příchuť, energetická hodnota),
- s **oznámenou cenou výrobce** — která **v přepočtu na referenční jednotku** nesmí být vyšší než nejvyšší oznámená cena jiné kategorizované potraviny ve stejné skupině (zabraňuje skoku),
- s **návrhem zařazení** do úhradové skupiny dle přílohy č. 6,
- s vyjádřením, zda FSMP je nutričně kompletní/nekompletní, se standardním/upraveným složením, jediný zdroj výživy či nikoli.

Změny údajů: ohlášení do 30 dnů; změnu **oznámené ceny** min. **30 dnů před uplatňováním**.

## § 39zd — Zařazování a vyřazování kategorizovaných FSMP

**Výklad:**

Ústav průběžně zveřejňuje ohlášení. Posuzuje, zda FSMP náleží do skupiny dle ohlášení.

#### Klíčový mechanismus — automatické zařazení nebo přesun (odst. 2)

Pokud Ústav usoudí, že FSMP náleží do **jiné** skupiny, **přímo ji zařadí do návrhu seznamu** s:

- cenou výrobce **vypočtenou z průměru** oznámených cen jiných FSMP v té skupině (přepočítáno na referenční jednotku);
- úhradou dopočtenou ze základní úhrady skupiny.

#### Námitkový mechanismus (odst. 3)

Ohlašovatel nebo **všechny** ZP mohou do 20. dne měsíce podat **odůvodněnou námitku**. Ústav potraviny ze seznamu vyřadí a zahájí **správní řízení** o zařazení (lhůta **75 dnů**). Tj. mlčenlivý souhlas + možnost prolomit námitkou.

#### Důvody vyřazení (odst. 4)

| Důvod | |
|---|---|
| nesprávné zařazení dle vlastností | objektivní rozpor |
| nedodávání na trh > 12 měsíců | absence aktivního zájmu |
| nesprávné ohlášení nebo neoznámené zvýšení ceny | procesní sankce |

## § 39ze — Stanovování základní úhrady úhradových skupin

**Výklad:**

SÚKL vydává **opatření obecné povahy (OOP)** s **roční účinností od 1. ledna**, **nejvýše jednou ročně, nejméně jednou za 5 let**. Základní úhrada se odvíjí od **celoevropských statistických ukazatelů Eurostatu** v mezidobí.

Výpočet úhrady kategorizované potraviny:

```
úhrada = (základní úhrada × počet ref. jednotek v balení)
       + max. obchodní přirážka
       + DPH
```

Tedy: jednotná „cena za referenční jednotku" (např. za 100 kcal, za 100 g) × počet těchto jednotek v balení = úhrada bez DPH a přirážky.

## § 39zf — Smlouvy s vlivem na cenu nebo úhradu FSMP

**Výklad:**

§ 39zf zavádí **dva typy smluvních mechanismů** mezi ZP a ohlašovatelem:

| Typ | Charakter |
|---|---|
| **Smlouva o nejvyšší ceně** (odst. 1) | závazek ohlašovatele dodávat nejvýše za smluvní cenu, min. 1 rok bez výpovědi |
| **Smlouva o ceně se závazkem dodávek** (odst. 2) | + pokrytí potřeby celé zaměnitelné skupiny — bez možnosti výpovědi |

#### Požadovaný tržní podíl pro smlouvu se závazkem (odst. 3)

| Struktura skupiny | Minimální podíl ohlašovatele za 12 měsíců |
|---|---|
| **3+ ohlašovatelů** v úhradové skupině | ≥ **35 %** |
| **< 3 ohlašovatelé** | ≥ **50 %** |

Logika: závazek dodávek musí dávat slíbit silný hráč schopný pokrýt poptávku celé skupiny.

#### Časově omezené snížení základní úhrady (odst. 5–9)

Pokud smluvní cena je „**způsobilá ovlivnit základní úhradu**" (tj. nižší než stávající základní úhrada), Ústav zahájí řízení o **OOP s časově omezeným snížením základní úhrady** pouze pro dotčenou skupinu. Vybere se **nejnižší cena** z předložených smluv; účinky od 1. dne druhého následujícího měsíce. Prodloužení o 1 rok, je-li smlouva prodloužena.

Pokud okolnosti pominou (smlouva skončí), Ústav neprodleně OOP zruší a úhrada se vrátí na původní úroveň.

#### Smluvní cena ZP (odst. 10)

Paralela § 39g odst. 13 (léčiva) — ZP a ohlašovatel mohou snížit cenu pro spotřebitele pro pojištěnce dané ZP. Závazná pro smluvní PZS po řádném oznámení.

## § 39zg — Stanovování maximálních cen a úhrady nekategorizovaných FSMP

**Výklad:**

§ 39zg je individuální správní řízení (paralela § 39a–h u léčiv) pro FSMP **mimo přílohu č. 6**:

#### Předpoklady (odst. 1)

- veřejný zájem dle § 17 odst. 2,
- nemožnost dostatečně ovlivnit zdravotní stav jinou metodou ZP, NEBO významný přínos,
- dostatečné důkazy o klinickém přínosu,
- splnění **CEA prahu** dle § 15 odst. 8.

#### Mechanismus výpočtu maximální ceny výrobce (odst. 7)

Třístupňová kaskáda (analogie § 39a):

- a) průměr cen ze 3 ČS EU s nejnižší cenou (seznam států ve vyhlášce MZd),
- b) cena z **písemné smlouvy ve veřejném zájmu** se ZP,
- c) cena nejbližší terapeuticky porovnatelné FSMP v ČR nebo EU.

#### Výše úhrady (odst. 9)

**Standardně 70 % nejvyšší ceny pro konečného spotřebitele** vypočtené z maximální ceny výrobce. Pojištěnec tedy doplácí **min. 30 %** + obchodní přirážku.

Výjimka: dají-li **všechny ZP** souhlas s vyšší úhradou ve veřejném zájmu, stanoví ji Ústav podle jejich vyjádření.

#### Doba řízení a vykonatelnost (odst. 11–13)

Lhůta pro rozhodnutí: **75 dnů**. Odvolání **nemá odkladný účinek** (analogicky § 39h odst. 4). Účinnost rozhodnutí dle data nabytí právní moci:

- do **10. dne** měsíce → od 1. dne následujícího měsíce,
- po 10. dni → od 1. dne **druhého** následujícího měsíce.

## § 39zh, § 39zi, § 39zj — Změny, hlášení, doručování

**§ 39zh** upravuje **změny a zrušení** maximální ceny / úhrady nekategorizované FSMP (paralela § 39i, j). Zrušit lze také z moci úřední, **nedodává-li se na trh > 12 měsíců**.

**§ 39zi** zavádí **hlášení o uvedení / přerušení / ukončení uvádění na trh** + **hlášení objemu dodávek** Ústavu (paralela hlášení distributorů léčiv dle zákona o léčivech). Účel: udržovat aktuální obraz dostupnosti FSMP na trhu, identifikovat výpadky pro krizový management.

**§ 39zj** doručování — opět **veřejnou vyhláškou** s dálkovým přístupem, doručeno **5. dnem** po vyvěšení.

## Klíčové vztahy s ostatními předpisy

### Vyhlášky MZd

| Předpis | Obsah |
|---|---|
| **vyhl. č. 376/2011 Sb.** | provádí § 39a–39u — detaily výpočtu cen a úhrad léčiv, rozhodné období, výjimky |
| **úhradová vyhláška** (vydávaná každoročně, např. **vyhl. č. 343/2025 Sb.** pro rok 2026) | dle § 17 odst. 5 — úhrady **zdravotních služeb a výkonů** PZS (paušál, výkon, DRG); **netýká se léčiv ani prostředků** |
| **vyhl. č. 89/2021 Sb.** | seznam kategorií zdravotnických prostředků s úhradovými limity (vykládá § 39r–y) |
| **cenový výměr MZd** | věcné usměrnění cen FSMP (§ 39za odst. 7), maximální obchodní přirážky |

### EU právo

- **Transparenční směrnice 89/105/EHS** — procesní pravidla, lhůty 90/180 dnů (recipována v § 39g odst. 2), pravidla pro publikaci, notifikaci Komisi;
- **Nař. (EU) 2021/2282 o HTA** — Joint Clinical Assessment od 1. 1. 2025 pro onkologika, ATMP, orphan drugs (§ 39b odst. 2 písm. l);
- **Nař. (EU) 2017/745 (MDR) a 2017/746 (IVDR)** — definice zdravotnických prostředků, UDI, certifikáty notifikovaných osob (citováno v § 39r–t);
- **Nař. (ES) 141/2000** — orphan drugs (§ 39da odst. 1);
- **Nař. (ES) 726/2004** — centralizovaná registrace + podmínečná registrace (§ 39d odst. 2 písm. c).

### Vazba na další části zákona č. 48/1997 Sb.

- **§ 13 odst. 2 písm. f)** (díl 02) — hrazená zdravotní péče zahrnuje léčivé přípravky a FSMP poskytované v rámci ambulantní péče;
- **§ 15 odst. 5–11** (díl 02) — obecná pravidla pro úhradu léčiv (úhrada na recept, podání během lůžkové péče, specializované pracoviště) — komentář vrátit do dílu 02;
- **§ 16b** (díl 02) — limit doplatků (5 000 / 1 000 / 500 Kč ročně dle věku a sociální situace) — započítávají se doplatky započitatelné do limitu dle § 39n odst. 1 písm. a);
- **§ 17 odst. 2** — veřejný zájem (úhradový aspekt: kvalita, dostupnost, finanční stabilita), referenční bod celé části šesté;
- **§ 44** — přestupky v oblasti regulace cen a úhrad (sankce za porušení dohod, závazků z aukce, ohlašovacích povinností).

## Časté otázky a typové situace

### „Proč na můj recept platím doplatek, když léčivo je hrazené?"

Hrazené je do výše **úhrady** (= základní úhrada referenční skupiny dle § 39c). Cena pro spotřebitele může být vyšší (lékárenská cena = cena výrobce + obchodní přirážka + DPH). **Rozdíl = doplatek**. Lék je „plně hrazen" jen tehdy, je-li cena ≤ úhrada — což zaručuje **pravidlo „jeden plně hrazený"** v každé skupině přílohy č. 2 (§ 39c odst. 5).

### „Co je doplatek započitatelný do limitu?"

Zveřejňuje se v Seznamu SÚKL (§ 39n odst. 1 písm. a). Jedná se o **nejnižší doplatek** v rámci nezaměnitelné skupiny v daném měsíci. Tj. zaplatíte-li za drahou variantu vyšší doplatek, do limitu § 16b se započte jen ten **referenční** (motivuje pacienty volit nejlevnější variantu).

### „Proč některé centrové léky nelze předepsat v ambulanci?"

Mají v podmínkách úhrady stanoveno **použití na specializovaném pracovišti** (§ 15 odst. 11) — typicky onkologika, biologika, modulátory CFTR, antikoagulancia s úzkým indikačním pásmem, VILP a orphan drugs. Předepsání ambulantním lékařem mimo center je možné, ale **neplatí úhrada** ze ZP.

### „Jak dlouho trvá vstup nového léčiva do úhrady?"

Standardně **165 dnů** (společné řízení o ceně i úhradě, § 39g odst. 2). U **vysoce inovativních** přípravků (§ 39d) může být řízení o dočasné úhradě výrazně rychlejší, ale doba do trvalé úhrady i s ní bývá 3–5 let. Reálná průměrná doba vstupu nového onkologika do úhrady v ČR je dle dat MZd a SÚKL kolem **18–24 měsíců** od EU registrace.

### „Co když výrobce přestane dodávat lék?"

ZP a Ústav mohou rozhodnout o **změně** nebo **zrušení úhrady** (§ 39i, j). Při nedostupnosti > 12 měsíců se úhrada automaticky ruší. Při výpadku spadá tíha zajištění alternativy na ZP a PZS, případně na zvláštní léčebné programy.

## Klíčové judikatury (přehled)

- **Pl. ÚS 36/11** (20. 6. 2013) — zrušení **regulačních poplatků** (30 Kč za návštěvu lékaře, 90 Kč za pohotovost) ve zdravotnictví. Konstatováno, že povinnost platit poplatek za poskytnutí (tehdy hrazené) zdravotní služby je v rozporu s čl. 31 Listiny (právo na zdravotní péči zdarma na základě veřejného pojištění). Promítlo se do **vypuštění § 16a** (regulační poplatky) z části páté zákona. Stop poplatek 30 Kč/den za hospitalizaci zůstal do 2015 (vypuštěn novelou 200/2015).
- **Pl. ÚS 19/13** — k systému regulačních omezení vůči PZS (objemové limity, „přeobjemy") — judikát potvrzuje pravomoc ZP regulovat objem hrazených služeb, ale s ohledem na proporcionalitu a předvídatelnost.
- **NSS 4 Ads 35/2013** a další — k řízení o úhradách léčiv — potvrzeno, že rozhodnutí SÚKL podléhají správnímu soudnictví; účastníci mají právo na **plný přístup k podkladům** (s výjimkou obchodního tajemství dle § 39f odst. 11–12).
- **SDEU C-296/03 Glaxosmithkline** (2005) a C-229/00 Komise v. Finsko (2003) — k výkladu transparenční směrnice, lhůty pro rozhodnutí, transparentnost kritérií, odůvodnění odmítnutí úhrady. SDEU důsledně vyžaduje **objektivní, ověřitelná a předem zveřejněná kritéria** — což česká úprava recipuje v § 39b odst. 2.

## Reformy a výhled

### Reforma 2024 (kategorizace zdravotnické techniky)

K **1. 1. 2024** nabyla plné účinnosti reforma:

- Kategorizace FSMP (§§ 39za–39zj) — viz výše;
- Dokončení implementace MDR (nař. 2017/745) v plné podobě;
- Posílení role center vysoce specializované péče u VILP a orphan drugs.

### Implementace EU HTA (od 1. 1. 2025)

Postupný náběh JCA (Joint Clinical Assessment) dle nař. (EU) 2021/2282:

- **2025**: onkologika a ATMP,
- **2028**: orphan drugs,
- **2030**: všechna léčiva s centralizovanou registrací.

Česko se účastní harmonizovaného procesu prostřednictvím **MZd a SÚKL jako národní koordinační kontaktní bod** a recipuje JCA do národního řízení (§ 39b odst. 2 písm. l).

### Probíhající diskuse (k 1. 1. 2026)

- **Reforma úhrady centrové péče** — diskutuje se o převedení části centrových léků (zejm. dlouhodobá udržovací léčba) z ZÚLP na recept se specializovaným pracovištěm — snížení administrativní zátěže;
- **Public-private financing models** pro nákladné ATMP (genové terapie s cenou 10+ mil. Kč) — zvažují se **annuity-based payment** a **outcomes-based contracting**;
- **Posílení tržního podílu generik** — diskuse o povinné substituci v lékárně (nyní jen v rámci dohod ZP–výrobci).

---

> **Souhrn dílu 03:** části šestá až osmá tvoří **kompletní právní rámec cenové a úhradové regulace** všeho zboží hrazeného ze ZP — léčivých přípravků, zdravotnických prostředků na poukaz a potravin pro zvláštní lékařské účely. Společná logika: stanovení **maximální ceny výrobce** (zpravidla ERP — průměr 3 nejnižších v EU), **základní úhrady referenční skupiny / úhradového limitu / základní úhrady úhradové skupiny FSMP**, periodické **revize** (hloubková, zkrácená), specifické režimy pro **vysoce inovativní léčiva, vzácná onemocnění a imunizační přípravky**, soutěžní mechanismy (**úhradová soutěž, cenová soutěž**) a smluvní nástroje (**ujednání ve veřejném zájmu, dohody se závazkem dodávek**). Z procesního hlediska dominuje **elektronická úřední deska SÚKL** (Věstník, Seznam) a **veřejná vyhláška jako doručovací režim**. Odvolání nemá odkladný účinek — důraz na efektivitu a rychlou aplikaci rozhodnutí. Pojištěnec je chráněn **garancí „jeden plně hrazený"** v každé třídě přílohy č. 2 a **stropem doplatků dle § 16b** (5 000 / 1 000 / 500 Kč ročně dle věku a sociální situace).
